...
INSERT INTO contracts (clientID, dateBegin, dateEnd, price) 
VALUES 
  ('0d067d44-fe99-450f-9044-2a7cb915f78c','1999-01-08', '1999-01-29',	15000),
  ('05a7fae3-26c5-4bf9-81f3-5885b330ba3c','1999-01-08', '1999-02-15',	15004),
  ('68d8b2f6-b7ee-4899-b399-5c3f414a98b7','1999-01-08', '1999-03-29',	15005),
  ('3568ef37-1d9a-4cb2-abee-7d92e32451e4','1999-01-08', '1999-04-29',	15006),
  ('ce5636f3-c29e-4ad7-999c-068ec2fc923f','1999-01-08', '1999-05-29',	15007)
ON CONFLICT (id) DO NOTHING;
--= ඞ =--